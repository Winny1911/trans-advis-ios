...
extension ViewBidsVM {
    func viewBidsApiCallHO(_ params :[String:Any],_ result:@escaping(ViewBidsResponseModelHO?) -> Void){
        Progress.instance.show()
        let headers: [String: String] = ["authorization": TA_Storage.shared.apiAccessToken]
        ApiManager<ViewBidsResponseModelHO>.makeApiCall(APIUrl.UserApis.viewBids, params: params, headers: headers, method: .put) { (response, resultModel) in
