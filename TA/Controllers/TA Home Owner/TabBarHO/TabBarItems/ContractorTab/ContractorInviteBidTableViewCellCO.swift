...
class ContractorInviteBidTableViewCellCO: UITableViewCell {
    var sendBtn  : (()-> ())?
    var initiateChatAction: (()-> ())?
    var userSkillArr = [UserSkills]()
    var selectedSkills = [String]()
    
    @IBOutlet weak var recomdedVwHeight: NSLayoutConstraint!
    ...
    override func awakeFromNib() {
        ...
        viewReviewsButton.isHidden = true
...
extension ContractorInviteBidTableViewCellCO: UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //cell.keySkillLbl.text = userSkillArr[indexPath.item].projectCategory?.title ?? ""
