...
////
////   let projectListingHOModel = try? newJSONDecoder().decode(ProjectListingHOModel.self, from: jsonData)
//
//import Foundation
//
//// MARK: - ProjectListingHOModel
//struct ProjectListingHOModel: Codable {
//    let statusCode: Int
//    let message: String
//    let data: DataClass
//}
...
//    let bids, tasks, contractorProject: [JSONAny]?
//
