...
class PastMainProjectVC: BaseViewController {
...
extension PastMainProjectVC: UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: 170, height:55)
    }
}

extension PastMainProjectVC: UICollectionViewDelegate{
    
}

extension PastMainProjectVC: UICollectionViewDataSource{
