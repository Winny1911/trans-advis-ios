...
class PastSubTaskVC: BaseViewController {
...
extension PastSubTaskVC: UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: 170, height:61)
    }
}

extension PastSubTaskVC: UICollectionViewDelegate{
    
}

extension PastSubTaskVC: UICollectionViewDataSource{
