...
class MainProjectTaskVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        if let newControllers = Controllers.mainProject{
            viewControllers.append(newControllers)
        }
        if let newControllers = Controllers.tasks{
            viewControllers.append(newControllers)
        }
//        if let newControllers = Controllers.orderlist{
//            viewControllers.append(newControllers)
//        }
//        viewControllers.append(Controllers.mainProject!)
//        viewControllers.append(Controllers.tasks!)
//        viewControllers.append(Controllers.orderlist!)
        
//        viewControllers.append(UIStoryboard(name: "MainProject", bundle: nil).instantiateViewController(withIdentifier: "MainProjectVC") as! BaseViewController)
//        viewControllers.append(UIStoryboard(name: "Tasks", bundle: nil).instantiateViewController(withIdentifier: "TasksVC") as! BaseViewController)
//        viewControllers.append(UIStoryboard(name: "Orderlist", bundle: nil).instantiateViewController(withIdentifier: "OrderlistVC") as! BaseViewController)
...
extension MainProjectTaskVC:UIPageViewControllerDelegate{

}

extension MainProjectTaskVC:UIPageViewControllerDataSource{
