...
class ArchiveProjectTaskVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        viewControllers.append(Controllers.archiveMainProject!)
        viewControllers.append(Controllers.archiveTasks!)
        viewControllers.append(Controllers.archiveOrderlist!)
...
extension ArchiveProjectTaskVC: UIPageViewControllerDelegate{

}

extension ArchiveProjectTaskVC: UIPageViewControllerDataSource{
